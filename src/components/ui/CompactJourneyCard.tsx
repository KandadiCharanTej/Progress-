...
export function CompactJourneyCard({
  ...
  return (
    <Link href={href} className="group block w-full">
      <div className="os-card p-2.5 flex items-center justify-between transition-all hover:border-[var(--accent-purple)]">
        <div className="flex items-center gap-2">
          <div className="flex h-7.5 w-7.5 items-center justify-center rounded-[8px] border border-[var(--border-color)] bg-[var(--bg-secondary)] text-[var(--accent-purple)] group-hover:bg-[var(--accent-purple)] group-hover:text-white transition-colors">
            <Icon className="h-3.5 w-3.5" />
          </div>
          <div>
            <div className="flex items-center gap-1.5">
              <h3 className="text-xs font-bold text-[var(--text-primary)] group-hover:text-[var(--accent-purple)] transition-colors">
                {title}
              </h3>
            ...
            <div className="mt-0.5 flex items-center gap-2">
              <div className="h-1.5 w-20 rounded-full bg-[var(--bg-secondary)] overflow-hidden border border-[var(--border-color)]">
                <div
